...
BOOT_SRC_FILES:=$(SRC_DIR)/bootloader.s $(SRC_DIR)/lineA20.s $(SRC_DIR)/gdt.s $(SRC_DIR)/paging.s $(SRC_DIR)/idt.s $(SRC_DIR)/display.s $(SRC_DIR)/string64.s $(SRC_DIR)/memory_mover.s $(SRC_DIR)/pic.s $(SRC_DIR)/keyboard.s
